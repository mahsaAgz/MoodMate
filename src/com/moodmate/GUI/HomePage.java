...
public class HomePage extends BaseHomePage {
    ...
    private static final int PART2_HEIGHT = 400; //
...
//    private static final int PART3_HEIGHT = 300; 
    ...
    public HomePage() {
        ...
        partTwoContainer.setLayout(new BoxLayout(partTwoContainer, BoxLayout.Y_AXIS));
        
//        int dynamicHeight = calculateDynamicHeight(); // Custom logic to calculate height
        ...
        try {
            ...
            if (suggestions.isEmpty()) {
                switch (timeframe.toLowerCase()) {
                    case "daily":
                        suggestions.add("No data for now No data for now No data for now" );
                        suggestions.add("Press Begin No data for now No data for now No data for now");
                        suggestions.add("and get personolized suggestions No data for now No data for now No data for now No data for now No data for now No data for now");
                        suggestions.add("No data for now No data for now No data for now No data for now");
                        suggestions.add("Press Begin No data for now No data for now No data for now");
                        suggestions.add("and get personolized suggestions No data for now No data for now No data for now No data for now No data for now No data for now");
                        break;
                    case "weekly":
